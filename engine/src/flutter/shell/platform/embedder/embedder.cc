...
MakeViewportMetricsFromWindowMetrics(
  ...
  metrics.physical_min_width = SAFE_ACCESS(flutter_metrics, min_width, 0.0);
  metrics.physical_min_height = SAFE_ACCESS(flutter_metrics, min_height, 0.0);
  metrics.physical_max_width = SAFE_ACCESS(flutter_metrics, max_width, 0.0);
  metrics.physical_max_height = SAFE_ACCESS(flutter_metrics, max_height, 0.0);
