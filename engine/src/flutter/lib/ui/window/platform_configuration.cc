...
bool PlatformConfiguration::AddView(int64_t view_id,
  ...
  tonic::CheckAndHandleError(tonic::DartInvoke(
      add_view_.Get(),
      {
          ...
          tonic::ToDart(view_metrics.physical_min_width),
          tonic::ToDart(view_metrics.physical_min_height),
          tonic::ToDart(view_metrics.physical_max_width),
          tonic::ToDart(view_metrics.physical_max_height),
